...
namespace Mirai_CSharp.Plugin.Interfaces
{
    ...
    public interface IDisconnected : IPlugin<IDisconnectedEventArgs>
    {
        ...
        Task Disconnected(IMiraiSession session, IDisconnectedEventArgs e);

        /// <inheritdoc/>
        Task IPlugin<IDisconnectedEventArgs>.HandleMessageAsync(IMiraiSession session, IDisconnectedEventArgs e)
        {
