...
namespace Mirai_CSharp.Plugin.Interfaces
{
    ...
    public interface IFriendMessage : IPlugin<IFriendMessageEventArgs>
    {
        ...
        Task FriendMessage(IMiraiSession session, IFriendMessageEventArgs e);

        /// <inheritdoc/>
        Task IPlugin<IFriendMessageEventArgs>.HandleMessageAsync(IMiraiSession session, IFriendMessageEventArgs e)
        {
