...
namespace Mirai_CSharp.Plugin.Interfaces
{
    ...
    public interface IGroupMessage : IPlugin<IGroupMessageEventArgs>
    {
        ...
        Task GroupMessage(IMiraiSession session, IGroupMessageEventArgs e);

        /// <inheritdoc/>
        Task IPlugin<IGroupMessageEventArgs>.HandleMessageAsync(IMiraiSession session, IGroupMessageEventArgs e)
        {
