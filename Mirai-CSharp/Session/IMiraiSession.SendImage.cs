...
namespace Mirai_CSharp
{
    public partial interface IMiraiSession
    {
        ...
        Task<ImageMessage> UploadPictureAsync(UploadTarget type, Stream image, CancellationToken token = default);
        ...
        Task<ImageMessage> UploadPictureAsync(UploadTarget type, string imagePath, CancellationToken token = default);
    }
}
